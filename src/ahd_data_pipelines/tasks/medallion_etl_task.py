...
from cdii_data_pipelines.transformations.drop_columns import DropColumns
from cdii_data_pipelines.transformations.rename_columns import RenameColumns
from cdii_data_pipelines.transformations.drop_duplicates import DropDuplicates
from cdii_data_pipelines.transformations.mutation_columns import MutateColumns
from cdii_data_pipelines.transformations.epoch_to_timestamp import EpochToTimestamp
from cdii_data_pipelines.transformations.string_replace import StringReplace
from cdii_data_pipelines.transformations.convert_zpoint import ConvertZPoint
from cdii_data_pipelines.transformations.fillna import FillNa
from cdii_data_pipelines.transformations.to_crs import ToCRS
    ...
    def transform(self, dataFrames: array, params: dict = None) -> array:
        ...
        if self.conf.get('bronze', False) is False:
            ...
            for index, dataFrame in enumerate(dataFrames):
                ...
                dataFrame = dataFrame.withColumn("ade_date_submitted",
                ...
                dataFrame = self.__do_outbound_transform(
                    transformations=transformations, dataFrame=dataFrame, params=this_params)
